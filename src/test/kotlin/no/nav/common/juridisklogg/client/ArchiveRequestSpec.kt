...
object ArchiveRequestSpec : Spek({
    ...
    given("new ArchiveRequests") {
        ...
        on("request without all required parameters") {
            it("should throw an exception") {
                { ArchiveRequest.Builder().setMessageId(id).build() } shouldThrow UninitializedPropertyAccessException::class
            }
        }
    }
})
